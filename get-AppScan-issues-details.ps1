...
#try {
   ...
   #$issuesUrl = "$BaseUrl/Issues/$IssueId?applyPolicies=None&`$top=100&`$count=false"
...
Write-Host "Summary: $issueCount issues found with status Open, Reopened, or In Progress"